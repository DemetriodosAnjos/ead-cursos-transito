          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-1 flex items-center justify-between">
              ...
              <span className="text-base font-extrabold text-white">
                {currentOrder.amount.toLocaleString("pt-BR", {
                  style: "currency",
                  currency: "BRL",
                })}
              </span>
            ...
            <div className="bg-emerald-950/30 border border-emerald-500/40 rounded-xl p-5 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-zinc-300 mt-2 leading-relaxed">
                  Identificamos o seu pagamento via{" "}
                  {currentOrder.paymentMethod === "CREDIT_CARD"
                    ? "Cartão de Crédito"
                    : currentOrder.paymentMethod === "DEBIT_CARD"
                      ? "Cartão de Débito"
                      : "Pix"}
                  . Seus dados foram enviados para o sistema DETRAN/RENACH.
                </p>
              </div>
              ...
              <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800 text-left space-y-2.5">
                ...
                <p className="text-xs text-zinc-300 leading-relaxed">
                  O link exclusivo e suas credenciais de acesso ao ambiente EAD
                  serão enviados manualmente para você por:
                </p>
                <div className="space-y-1.5 text-xs text-zinc-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      WhatsApp:{" "}
                      <strong>
                        {currentOrder.customerWhatsapp || "Cadastrado"}
                      </strong>
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      E-mail: <strong>{currentOrder.customerEmail}</strong>
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              {activeTab === "pix" && (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col items-center justify-center p-4 bg-white rounded-xl shadow-inner max-w-[240px] mx-auto">
                    ...
                    <span className="text-[11px] font-bold text-zinc-800 mt-1">
                ...
                <div className="p-4 bg-zinc-950 rounded-xl border border-zinc-800 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400">
                        Pague em até 12x com aprovação instantânea pelo Mercado
                        Pago.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-zinc-900/90 p-3 rounded-lg border border-zinc-800 text-xs space-y-2 text-zinc-300">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-zinc-400">
                        Caixa Virtual, Nubank, Inter e outros
                      </span>
                    </div>
                  </div>
                  ...
                  <p className="text-center text-[10px] text-zinc-500">
                    Ambiente criptografado e seguro processado pela
                    infraestrutura oficial do Mercado Pago.
                  </p>
                </div>
              )}
              ...
              <div className="p-3.5 bg-gradient-to-r from-zinc-950 to-zinc-900 rounded-xl border border-zinc-800 text-xs space-y-2">
                ...
                <p className="text-zinc-400 text-[11px] leading-relaxed">
                  Não se preocupe! Sua pré-matrícula já está salva no banco.
                  Você pode reabrir esta mesma tela de pagamento a qualquer
                  momento pelo link da 2ª via:
                </p>
